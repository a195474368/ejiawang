 ...
 * $Id: content.ctl.php 3975 2014-03-19 02:47:00Z langzhong $
 */
class Ctl_Content extends Ctl {
    ...
    public function diaryDetail($diary_id, $page = 1)
    {
        ...
        elseif (!$detail['audit']) {
            ...
            $this->pagedata['contents'] = K::M('diary/detail')->items(array('diary_id' => $diary_id), array('detail_id' => 'desc'), 1, $detail['content_num']);
