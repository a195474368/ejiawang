...
{   
    ...
    protected $_cols = 'city_id,provinces_id,city_name,pinyin,theme_id,seo_title,seo_keywords,seo_description,orderby,audit,dateline';
    protected $_orderby = array('orderby'=>'ASC', 'city_id'=>'ASC');
    protected $_pre_cache_key = 'data-city-list';
    //protected $_hubei = array('武汉','');
    // public function get_hubei(){
