<?php /* Smarty version Smarty-3.1.8, created on 2015-08-22 11:23:52
         compiled from "mobile:company/yuyue.html" */ ?>
<?php /*%%SmartyHeaderCode:95579063955d7eb4872be76-26146669%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '43479b58d8fc27a567cee2efc36de5be9bb8a727' => 
    array (
      0 => 'mobile:company/yuyue.html',
      1 => 1432651345,
      2 => 'mobile',
    ),
  ),
  'nocache_hash' => '95579063955d7eb4872be76-26146669',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55d7eb487d9f04_05181860',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55d7eb487d9f04_05181860')) {function content_55d7eb487d9f04_05181860($_smarty_tpl) {?><?php if (!is_callable('smarty_function_link')) include '/www/wwwroot/www.fzgxw.com/system/plugins/smarty/function.link.php';
...
<!--头部开始-->
	<div class="mobile_top">
    	<div class="mobile_top_son">
            ...
            <div class="detail-second">免费申请设计/量房</div>
        </div>
    </div>
    <div class="h45"></div>
<!--头部结束-->
	...
	<div class="mobile_main hauto">
    	<div class="mobile_tenders">
        	<form id='tenders_form'>
            	<table>
                    <tr>
                        <td><h2>预约：<?php echo $_smarty_tpl->tpl_vars['detail']->value['name'];?>
</h2></td>
                    </tr>
                    ...
                    <tr>
                    	<td><i>*</i>&nbsp;&nbsp;预约业主可享受免费上门量房、设计及报价</td>
                    </tr>
                    <tr>
                    	<td height="60"><input type="button" id='tender_submit' class="public_text1" value="立刻预约"/></td>
                    </tr>
...
<script type="text/javascript">
    ...
    (function(K, $) {
        ...
        $("#tender_submit").click(function(){
          if (lock == 0) {    
                lock = 1;
                $.post("<?php echo smarty_function_link(array('ctl'=>'company:yuyue','arg0'=>$_smarty_tpl->tpl_vars['detail']->value['company_id']),$_smarty_tpl);?>
