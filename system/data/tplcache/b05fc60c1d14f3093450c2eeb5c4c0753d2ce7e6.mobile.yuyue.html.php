<?php /* Smarty version Smarty-3.1.8, created on 2015-08-22 14:47:47
         compiled from "mobile:site/yuyue.html" */ ?>
<?php /*%%SmartyHeaderCode:107298182955d81b135ba231-88163442%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b05fc60c1d14f3093450c2eeb5c4c0753d2ce7e6' => 
    array (
      0 => 'mobile:site/yuyue.html',
      1 => 1420010589,
      2 => 'mobile',
    ),
  ),
  'nocache_hash' => '107298182955d81b135ba231-88163442',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55d81b1365bdf0_37080459',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55d81b1365bdf0_37080459')) {function content_55d81b1365bdf0_37080459($_smarty_tpl) {?><?php if (!is_callable('smarty_function_link')) include '/www/wwwroot/www.fzgxw.com/system/plugins/smarty/function.link.php';
...
<!--头部开始-->
	<div class="mobile_top">
    	<div class="mobile_top_son">
            ...
            <div class="detail-second">预约参观</div>
        </div>
    </div>
    <div class="h45"></div>
<!--头部结束-->
	...
	<div class="mobile_main hauto">
    	<div class="mobile_tenders">
        	<form id='tenders_form'>
            	<table>
                    <tr>
                        <td><h2>预约参观：<?php echo $_smarty_tpl->tpl_vars['detail']->value['title'];?>
</h2></td>
                    </tr>
...
<script type="text/javascript">
    ...
    (function(K, $) {
        ...
        $("#tender_submit").click(function(){
          if (lock == 0) {    
                lock = 1;
                $.post("<?php echo smarty_function_link(array('ctl'=>'site:yuyue','arg0'=>$_smarty_tpl->tpl_vars['detail']->value['site_id']),$_smarty_tpl);?>
