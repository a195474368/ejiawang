<?php /* Smarty version Smarty-3.1.8, created on 2015-08-22 11:20:21
         compiled from "/www/wwwroot/www.fzgxw.com/themes/new_green/block/header.html" */ ?>
<?php /*%%SmartyHeaderCode:179178315855d7ea7554ac55-68924553%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '861f363355958c9fe4c6ebf2837584a11ec2a3db' => 
    array (
      0 => '/www/wwwroot/www.fzgxw.com/themes/new_green/block/header.html',
      1 => 1440138032,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '179178315855d7ea7554ac55-68924553',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55d7ea7571b5e8_78004481',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55d7ea7571b5e8_78004481')) {function content_55d7ea7571b5e8_78004481($_smarty_tpl) {?><?php if (!is_callable('smarty_function_link')) include '/www/wwwroot/www.fzgxw.com/system/plugins/smarty/function.link.php';
?><!DOCTYPE html>
<html>
    ...
    <div class="style2_main_menu mt20">
        <div class="style2_main_menu_t" style="height:46px">
                ...
                <div class="style2_main_menu_r lt" >
                	<ul class="menu_ul">
                    	<li class="menu_main">
                        	<a class="menu_main_a <?php if ($_smarty_tpl->tpl_vars['request']->value['ctl']=='index'){?>current9<?php }?>" href="/">首页 </a>
                        </li>
                    	<li class="menu_main">
                            <img  style="position:absolute;top:-20px;right:2px"src="<?php echo $_smarty_tpl->tpl_vars['pager']->value['theme'];?>
/images/host.png" />
                        	<sup></sup><a title='我要装修'  class="menu_main_a <?php if ($_smarty_tpl->tpl_vars['request']->value['ctl']=='tenders'){?>current9<?php }?>" href="<?php echo smarty_function_link(array('ctl'=>'tenders-index2'),$_smarty_tpl);?>
">设计/报价</a>
                        </li>
                         <li class="menu_main">
